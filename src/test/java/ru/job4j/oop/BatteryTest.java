...
public class BatteryTest {
    ...
    @Test
    public void whenThis0Another50ThenAnotherLoadEqual50() {
    ...
    @Test
    public void whenThis10Another50ThenAnotherLoadEqual60AndFirstEqual0() {
        Battery charger = new Battery(10);
        Battery another = new Battery(50);
        charger.exchange(another);
        int expectedAnother = 60;
        int expectedCharger = 0;
        assertThat(another.about()).isEqualTo("My charge: " + expectedAnother + "%");
        assertThat(charger.about()).isEqualTo("My charge: " + expectedCharger + "%");
    }
}